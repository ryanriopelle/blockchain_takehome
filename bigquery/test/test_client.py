...
class TestConfig(TestCase):
    ...
    def test_get_top_n_addresses_query(self):
        ...
        self.assertTrue('block_timestamp_month >= DATE_TRUNC(DATE "2021-01-01", MONTH)' in top_n_addresses_query)
        self.assertTrue('block_timestamp_month <= DATE_TRUNC(DATE "2021-01-25", MONTH)' in top_n_addresses_query)
